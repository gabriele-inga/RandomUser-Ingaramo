...
class App {
  constructor() {
    ...
    // Imposta lo stile CSS per posizionare il canvas dietro tutto
    ...
    this.renderer.domElement.style.pointerEvents = 'none'; // Permette click attraverso
    ...
    this.colorSchemes = {
    1: {
        // TEMA CHIARO: Bianco, azzurrino, beige
        color1: new THREE.Vector3(1.0, 1.0, 1.0),        // Bianco puro
        color2: new THREE.Vector3(0.7, 0.85, 0.95),      // Azzurrino chiaro
        color3: new THREE.Vector3(0.96, 0.92, 0.84),     // Beige chiaro
        color4: new THREE.Vector3(0.9, 0.95, 1.0),       // Azzurro molto chiaro
        color5: new THREE.Vector3(1.0, 0.98, 0.94),      // Bianco crema
        color6: new THREE.Vector3(0.8, 0.88, 0.96)       // Azzurro pastello
    },
    2: {
        // TEMA SCURO: Nero, viola, blu scuro
        color1: new THREE.Vector3(0.05, 0.05, 0.1),      // Nero-blu scuro
        color2: new THREE.Vector3(0.05, 0.05, 0.1),        // Viola scuro
        color3: new THREE.Vector3(0.1, 0.15, 0.3),       // Blu notte
        color4: new THREE.Vector3(0.15, 0.2, 0.6),        // Viola medio
        color5: new THREE.Vector3(0.15, 0.2, 0.4),       // Blu scuro
        color6: new THREE.Vector3(0.25, 0.1, 0.45)       // Viola-blu
    },
      3: {
